...
<div id="body-container">
	...
	<div id="header-container">
		<header class="cf" <?php if( isset($header_bg) ) echo $header_bg; ?>>
			...
			<div id="logo-wrap">
				<?php
					...
					PC_Utility::pc_display_customizer_site_logo();

					global $pc_customizer_defaults;
					$chk_hide_description = get_theme_mod( 'chk_hide_description', $pc_customizer_defaults['chk_hide_description'] );

					if ( empty($chk_hide_description) ) { ?>
